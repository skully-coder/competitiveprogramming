export default function Home() {
    return ( <
        ...
        rel = "noreferrer"
        href = "https://github.com/skully-coder/competitiveprogramming" > repository < /a>.</h
        4 >
        <
        p style = {
            { fontSize: "1.5rem" }
        ...
        <
        h4 className = "m-5" > < u > Contribution Guidelines < /u>:</h
        4 >
        <
        h6 >
        <
        ...
        /competitiveprogramming</code > < /li> <
