export default function Home() {
    return ( <div className = "container-fluid" >
        <h1 className = "font-weight-semi-bold text-center text-extra-letter-spacing" > Competitive Programming Solutions Compilation </h1> <div className = "row row-eq-spacing" >
        <div className = "col-12 col-md-6" >
        <div className = "card shadow-lg text-center" >
        <h4 > This Website Contains all <b > Contents </b>, <b>Issues</b > of our <a target = "_blank"
        rel = "noreferrer"
        href = "https://github.com/skully-coder/competitiveprogramming" > repository </a>.</h4 >
        <p style = {
            { fontSize: "1.5rem" }
        } > This repository contains <b > solutions </b> and <b>explanations</b > to various <b > competitive programming problems </b>, which are important for <b>interviews</b > and <b > online tests </b> of different companies.</p >
        <h4 > < u > Stargazers over time </u>:</h4 >
        <img src = "https://starchart.cc/skully-coder/competitiveprogramming.svg"
        width = "100%"
        ...
        <li > < b > Clone </b> your forked repository <code className="bg-light-lm bg-dark-light-dm text-center p-5 rounded">git clone https:/ / github.com / & lt; your - username & gt;
