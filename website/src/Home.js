			...
			<div className="row row-eq-spacing">
				<div className="col-12 col-md-6">
					<div className="card shadow-lg text-center">
						<h4>This Website Contains all <b>Contents</b>, <b>Issues</b> of our <a target="_blank" rel="noreferrer" href="https://github.com/skully-coder/competitiveprogramming">repository</a>.</h4>
						...
						<img src="https://starchart.cc/skully-coder/competitiveprogramming.svg" width="100%" alt="Stargazers over time" />
					</div>
				</div>
						...
						<h6>
							<ol>
								...
								<li><b>Clone</b> your forked repository<br />
									&emsp;<code className="bg-light-lm bg-dark-light-dm text-center p-5 rounded">git clone https://github.com/&lt;your-username&gt;/competitiveprogramming</code>
								</li>
								<li>In the cloned repository, <b>Create</b> a folder with the problem name, under the <b>most suitable topic</b>.<br />
									&emsp;Eg. <code className="bg-light-lm bg-dark-light-dm text-center p-5 rounded">competitiveprogramming / <span className="text-danger">BackTracking</span> / <span className="text-primary font-weight-bold">N-Queens</span></code>
								</li>
